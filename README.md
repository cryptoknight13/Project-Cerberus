...
cd Project-Cerberus
~/.local/bin/repo init -u https://github.com/cryptoknight13/cerberus-dev-manifest -b master (In this example, repo is located in ~/.local/bin/repo. Change this to be the location of the repo program)
~/.local/bin/repo sync
cd cerberus
rm -rf build
mkdir build
